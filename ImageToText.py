'''
our modifications:
our code takes file name from the user
it displays the picture at different stages automatically while the code is running
it opens the text file automatically once program is done running
'''
